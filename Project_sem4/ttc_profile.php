...
if (isset($_SESSION['ID'])) {
    ...
    $sql = "SELECT * FROM TTCORD WHERE TTC_ID = '$ID'";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p><strong>Timetable Coordinator ID:</strong> " . $row[ "TTC_ID"]. "</p>";
        echo "<p><strong>First Name:</strong> " . $row["First_Name"]. "</p>";
        echo "<p><strong>Last Name:</strong> " . $row["Last_Name"]. "</p>";
        echo "<p><strong>Date of Joining:</strong> " . $row["TTC_DOJ"]. "</p>";
        echo "<p><strong>Date of Birth:</strong> " . $row["TTC_DOB"]. "</p>";
        echo "<p><strong>Password:</strong> " . $row["TTC_Password"]. "</p>";
...
?>
<a href="update_ttc.php"><button>Update Profile</button></a>
    </div>
</body>
</html>
