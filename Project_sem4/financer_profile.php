...
if (isset($_SESSION['ID'])) {
    ...
    $sql = "SELECT * FROM Financer WHERE F_ID = '$ID'";
    $sql1 = "SELECT * FROM Financer_Email WHERE F_ID = '$ID'";
    $sql2 = "SELECT * FROM Financer_Mobile WHERE F_ID = '$ID'";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p><strong>Professor ID:</strong> " . $row["F_ID"]. "</p>";
        echo "<p><strong>First Name:</strong> " . $row["First_Name"]. "</p>";
        echo "<p><strong>Last Name:</strong> " . $row["Last_Name"]. "</p>";
        echo "<p><strong>Date of Joining:</strong> " . $row["F_DOJ"]. "</p>";
        echo "<p><strong>Date of Birth:</strong> " . $row["F_DOB"]. "</p>";
        echo "<p><strong>Password:</strong> " . $row["F_Password"]. "</p>";
        ...
        echo "<p><strong>Email:</strong> " . $row1["F_Email"]. "</p>";
        echo "<p><strong>Mob No:</strong> " . $row2["F_Mobile"]. "</p>";
        echo "</div>";
        $conn->close();
...
?>
<a href="update_financer.php"><button>Update Profile</button></a>
    </div>
</body>
</html>
